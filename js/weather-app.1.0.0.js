...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = function app() {
		...
		function generateWeatherResults(result) {
			$('.current-weather-img').html('<img class="current-weather-img" src=' + result.current_condition[0].weatherIconUrl[0].value + '>');
			$('.place').html('<h1>' + result.request[0].query + '</h2><h3> Date ' + result.time_zone[0].localtime + '</h3><h3>Temperature ' + result.current_condition[0].temp_F + 'F/' + result.current_condition[0].temp_C + 'C ' + result.current_condition[0].weatherDesc[0].value + '</h3>');
			var dayNum = 0;
...
/***/ }
/******/ ]);
//# sourceMappingURL=weather-app.1.0.0.js.map